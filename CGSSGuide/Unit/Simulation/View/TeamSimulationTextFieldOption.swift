//
//  TeamSimulationTextFieldOption.swift
//  CGSSGuide
//
...
class TeamSimulationTextFieldOption: UIControl {

    let label: UILabel
    let textField: TeamSimulationAppealInputTextField
    
    
    override init(frame: CGRect) {
        label = UILabel()
        textField = TeamSimulationAppealInputTextField()
