...
class LiveFilterSortController: BaseFilterSortController {
    ...
    var sorterMethods = ["updateId", "startDate", "bpm", "maxDiffStars", "maxNumberOfNotes", "sLength", "nameKana", "normalPercent", "holdPercent", "flickPercent", "slidePercent"]
    
    var sorterTitles = [NSLocalizedString("变更时间", comment: ""), NSLocalizedString("首次出现时间", comment: ""), "bpm", NSLocalizedString("难度", comment: ""), NSLocalizedString("note数", comment: ""), NSLocalizedString("时长", comment: ""), NSLocalizedString("五十音", comment: ""), "normal%", "hold%", "flick%", "slide%"]
