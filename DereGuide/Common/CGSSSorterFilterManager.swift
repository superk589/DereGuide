...
class CGSSSorterFilterManager {
    ...
    struct DefaultFilter {
        static let card = CGSSCardFilter(cardMask: 0b111, attributeMask: 0b111, rarityMask: 0b11110000, skillMask: 0b1111_1111_1111_1111_1111, gachaMask: 0b11111, conditionMask: 0b1111111, procMask: 0b1111, favoriteMask: nil)
        static let unitCard = CGSSCardFilter(cardMask: 0b111, attributeMask: 0b111, rarityMask: 0b10100000, skillMask: 0b0111_1111_1111_1000_0111, gachaMask: 0b11111, conditionMask: 0b1111111, procMask: 0b1111,  favoriteMask: nil)
        ...
        static let event = CGSSEventFilter(typeMask: 0b1111111)
        static let gacha = CGSSCardFilter(cardMask: 0b111, attributeMask: 0b111, rarityMask: 0b11111111, skillMask: 0b1111_1111_1111_1111_1111, gachaMask: 0b11111,  conditionMask: 0b1111111, procMask: 0b1111, favoriteMask: nil)
