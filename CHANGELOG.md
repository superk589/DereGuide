...
1. 模拟算分增加查看得分详情的功能
2. 针对官方提供准确几率的卡池，查看完整可抽列表页面现在也显示每张卡的实际几率，修复2017/3/28日的Fes卡池几率不准确问题
3. 修复队伍中存在“技能增强”类特技时，直接计算的平均分数不准确的问题
4. 新增app内评分的功能(iOS 10.3+)
...
1. 近日中に追加した「スキルブースト」新しい特技を対応します
